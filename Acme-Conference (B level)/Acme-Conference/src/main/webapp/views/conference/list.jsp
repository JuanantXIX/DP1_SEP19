...
<display:column property = "category.title[0]" titleKey = "conference.category" sortable="true" sortName="title[0]" headerClass="sortable"/>
</jstl:if>


	<jstl:if test="${language=='es'}" >
<display:column property = "category.title[1]" titleKey = "conference.category" sortable="true" sortName="title[1]" headerClass="sortable"/>
</jstl:if>
