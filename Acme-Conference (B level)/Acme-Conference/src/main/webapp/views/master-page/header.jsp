...
<br/>
	...
	<li><a class="fNiv"><spring:message	code="conference.master.title" /></a>
		...
		<security:authorize access="hasRole('ADMIN')">
			...
			<li><a class="fNiv"><spring:message	code="conference.administrator.header" /></a>
				<ul>
					...
					<li><a href="category/administrator/list.do"><spring:message code="category.header.link" /></a></li>
		...
		<li><a href="finder/author/list.do"><spring:message code="finder.header.link" /> </a></li>
